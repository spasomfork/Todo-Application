...
We use **Jest** for unit testing both layers.
**Note**: Ensure you have applied the code fixes mentioned in `compliance_code.md` for tests to pass.
...
We use **Cypress** for full E2E flows.
**Note**: Ensure Backend (port 5000) and Frontend (port 3000) are running.
